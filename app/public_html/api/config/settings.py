...
INSTALLED_APPS = [
    ...
    'apps.chat.apps.ChatConfig',  # Chat with WebSocket
]
...
# Channel layer: In-memory only (cPanel has no Redis). Best-effort single-process WebSocket support.
CHANNEL_LAYERS = {
    'default': {
...
# Logging configuration (handles missing logs/ directory gracefully)
