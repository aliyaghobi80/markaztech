...
from .views import (
    ...
    WalletChargeRequestViewSet, AdminWalletAdjustmentView, AdminStatisticsView, LogoutView,
    TicketViewSet, SiteStatsView, SatisfactionVoteViewSet, SiteSettingsView
)
from rest_framework_simplejwt.views import TokenRefreshView

router = DefaultRouter()
router.register(r'list', UserViewSet, basename='user-management')
router.register(r'wallet-requests', WalletChargeRequestViewSet, basename='wallet-requests')
router.register(r'tickets', TicketViewSet, basename='tickets')
router.register(r'satisfaction', SatisfactionVoteViewSet, basename='satisfaction')
